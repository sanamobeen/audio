...
from .exceptions import UnknownFrameError, InvalidPaddingError, InvalidFrameError
...
class Frame(object):
    ...
    def __repr__(self):
        ...
        return ("{type}(Stream: {stream}; Flags: {flags}): {body}").format(
            type=type(self).__name__, stream=self.stream_id, flags=flags, body=body
        )
...
class Priority(object):
    ...
    def __init__(
        self, stream_id, depends_on=0x0, stream_weight=0x0, exclusive=False, **kwargs
    ):
...
class GoAwayFrame(Frame):
    ...
    def __init__(
        self, stream_id=0, last_stream_id=0, error_code=0, additional_data=b"", **kwargs
    ):
