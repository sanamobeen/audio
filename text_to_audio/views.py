...
class TextToSpeechView(APIView):
    ...
    def post(self, request):
        ...
        voice = "en-US-JennyNeural"  # You can customize or make this dynamic
    ...
    def post(self, request):
        ...
        for lang in languages:
            try:
                ...
                # Generate and save audio asynchronously
                asyncio.run(
                    edge_tts.Communicate(text=translated_text, voice=voice).save(
                        filepath
                    )
                )
